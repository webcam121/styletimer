<?php
	// General
	$moxieManagerConfig['general.license'] = 'TQTC-YHWE-ZO2A-KBC4-DSBI-6AGW-C4X3-FFPR';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = '../../../../../media';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "meejoin", "password" => "meejoin", "groups" => array("administrator"))
	);
