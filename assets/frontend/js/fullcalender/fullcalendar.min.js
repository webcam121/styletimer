...
! function(t) {
    ...
    var Te = Zt.TimeGrid = be.extend(Ee, {
        ...
        renderNowIndicator: function(e) {
            var n, i = this.spanToSegs({
                ...
                s = [];
                var dt=moment(e._d).utcOffset('+0000').format('HH:mm');
                //console.log(dt);
            ...
            i.length > 0 && s.push(t('<div class="fc-now-indicator fc-now-indicator-arrow" style="color:red;text-align:center;font-size:12px;">'+dt+'</div>').css("top", r-3).appendTo(this.el.find(".fc-content-skeleton"))[0]), this.nowIndicatorEls = t(s)
        },
        unrenderNowIndicator: function() {
    ...
    Te.mixin({
        ...
        fgSegHtml: function(t, e) {
            ...
            var note = '';
            if (o.add_class == "block-time-bg" || o.blocked_type=='close') {
                note = "<br/>"+ht(o.notes);
            }
            if(o.blocked_type=='close'){
                return h.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="'+ht(o.status)+' ' + h.join(" ") + ' event-grayline eventDetails'+o.id+'"' + (o.url ? ' href="' + ht(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' +"</span></div>" : "") + (o.userName ? '<div class="fc-title" style="color:#333333"><b>' + ht(o.userName) + "</b><br/>"+ ht(o.serviceName)+note+"</div>" : '<div class="fc-title">'+ ht(o.serviceName)+note+"</div>") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
            }
			else{	   
              return h.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="'+ht(o.status)+' ' + h.join(" ") + ' '+o.add_class+' eventDetails'+o.id+'"' + (o.url ? ' href="' + ht(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' + ht(n) + "</span></div>" : "") + (o.userName ? '<div class="fc-title" style="color:#333333"><b>' + ht(o.userName) + "</b><br/>"+ ht(o.serviceName)+note+"</div>" : '<div class="fc-title">'+ ht(o.serviceName)+note+"</div>") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
		  }
        },
