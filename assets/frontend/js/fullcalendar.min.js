        ...
        var l = n(2),
            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    return '<a data-title="'+d.title+'" data-fulltime="'+ u.htmlEscape(n) +'" class="viewMoreDetail ' + f.join(" ") + '"' + (d.url ? ' href="' + u.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + u.htmlEscape(i) + '" data-full="' + u.htmlEscape(r) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") + (d.title ? '<div class="fc-title" style="display:none;">' +d.title+ "</div>" : "") + '</div><div class="fc-bg"/>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
            ...
            u = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    var n, r, i = this.view,
                        ...
                        h = "";
                    return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"), r = '</br><span class="fc-title test" style="word-break: break-word !important;">' +o.title+ "</span>", '<a class="' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
