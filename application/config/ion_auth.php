...
*/
$config['tables']['users']           = 'st_users';
$config['tables']['groups']          = 'groups';
$config['tables']['users_groups']    = 'users_groups';
$config['tables']['login_attempts']  = 'st_login_attempts';
 ...
 */
$config['site_title']                 = "styletimer.com";       // Site Title, example.com
$config['admin_email']                = "harshan.shantiinfotech@gmail.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 1296000000;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
