                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 contact-img-bg">
                        <div class="relative text-center ">
                            <h3 class="fontsize-34 colorwhite  fontfamily-semibold mb-0"><?php if(!empty($dsgvo->title)) echo $dsgvo->title; else echo 'DSGVO';  ?></h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                       <?php if(!empty($dsgvo->text)) echo $dsgvo->text;  ?>
                    </div>
                </div>
