...
<section class="login_register_sections clear">
    <div class="pl-15 pr-15">
        <div class="row">
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 align-self-center login_register_main_left_block">
              <div class="row">
                   <div class="login_register_main_left_block_overlay around-50">
                        <div class="relative " id="user-avtar">
            ...
            <div class="col-xl-5 col-lg-6 col-md-7 col-sm-12 col-12 m-auto d-flex height-vh justify-content-center">
              <div class="relative align-self-center d-flex flex-row login_register_main_right_block w-100" id="lrmrb_scroll">
                <div class="relative align-self-center w-100">
                    <h2 class="font-size-36 color333 fontfamily-medium mb-60 text-center">Register as User</h2>
                    <?php  
                    echo $this->session->flashdata('err_message'); ?>
                    <div class="relative login_register_form_block">
                         <form id="userRegistration" method="post" 
                         action="<?php echo base_url('auth/registration/user') ?>">
                             <div class="row">
                                       ...
                                       <div class="form-group text-left">
                                            <div class="checkbox mt-0 mb-2" id="termsDiv">
                                                <label class="fontsize-12 fontfamily-regular color333"><input type="checkbox" name="remember" value="" id="terms" name="terms">
                                                  ...
                                                  I agree to the <a class="colororange a_hover_orange popup_terms" data-type="terms" data-access="user" href="javascript:void(0)"> terms and conditions </a> & <a href="javascript:void(0)" class="colororange a_hover_orange popup_terms" data-type="policy" data-access="user">privacy policy</a> of styletimer.
                                                </label>
                                            </div>  
