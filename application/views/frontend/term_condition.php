                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 contact-img-bg">
                        <div class="relative text-center ">
                            <h3 class="fontsize-34 colorwhite  fontfamily-semibold mb-0"><?php if(!empty($terms->title)) echo $terms->title; else echo 'About Us';  ?></h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                       <?php if(!empty($terms->text)) echo $terms->text;  ?>
                    </div>
                </div>
