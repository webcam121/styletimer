    ...
    <section class="clear membership_payment_section2 v1 pt-50 pb-60 bgwight">
      <div class="container">
        <div class="text-center">
          ...
          <p class="font-size-24 color333 fontfamily-medium"><?php echo $this->lang->line('amount_need_to'); ?></p>
          <h1 class="font-size-50 colororange fontfamily-regular display-ib" style="margin-bottom:0px;"><?php if(!empty($planDetail->price)) echo $planDetail->price; ?>€<small class="fontfamily-light colororange font-size-16 display-ib">/ <?php echo $this->lang->line('Montly'); ?></small></h1>
        </div>
        <div class="text-center mb-30">
          <span class="fontfamily-light font-size-14 display-ib">
            zuzügl. 19% MwSt.
          </span>
        </div>
        <div class="row">
                ...
                <div class="radio mt-0 mb-3">
                      <label class="fontsize-14 pl0 color333">
                         <input type="radio" class="paymentoption" name="payment_method" value="card" checked="checked">
                          ...
                          <?php echo $this->lang->line('credit_debit_cart'); ?>
                          </label>
                    </div>
                    <div class="radio mt-0 mb-4">
                        <label class="fontsize-14 pl0 color333">
                          <input type="radio" class="paymentoption" name="payment_method" value="sepa_debit">
                            <span class="cr"><i class="cr-icon fas fa-circle"></i></span>
                            <?php echo $this->lang->line('sepa_direct_debit'); ?>
                        </label>
                    </div>
                  </div>
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                 <form id="paymentForm">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-lg-6 col-xl-6 pr-1">
                      ...
                      <div class="relative form-group-mb-50" id="expir_month_year_validate">
                        ...
                        <div class="input-group-prepend ">
                          <span class="input-group-text bge8e8e8 pl-1 pr-1"><?php echo $this->lang->line('MM/YY'); ?></span>
                        </div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-large" type="button" id="submitpay"><?php echo $this->lang->line('Pay'); ?></button>
                    </div>
                  </div>
                  <input type="hidden" name="planid" value="<?php if(!empty($plan_id)) echo $plan_id; ?>"> 

                </form>
                 <form id="sepapaymentForm" class="display-n">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <button class="btn btn-large" type="button" id="submitsepapay"><?php echo $this->lang->line('Pay'); ?></button>
                    </div>
                  </div>
                    <input type="hidden" name="planid" value="<?php if(!empty($plan_id)) echo $plan_id; ?>"> 
               </form>
...
if(!isNaN(val)) {
    ...
    $(document).on('change','.paymentoption',function(){
       if($(this).val()=='card'){
        $("#sepapaymentForm").addClass('display-n');
        $("#paymentForm").removeClass('display-n');
       }else{
          $("#paymentForm").addClass('display-n');
          $("#sepapaymentForm").removeClass('display-n');
