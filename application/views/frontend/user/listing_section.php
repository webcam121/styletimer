...
if(!empty($usersdetail)) {
  foreach($usersdetail as $user) {
    $hrefUrl=base_url("salons/" . urlencode($user->slug) .'/'. rawurlencode(replace_spec_char($user->city)));
    if ($user->slug == '') {
                      ...
                      <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
                        ...
                        <?php 
                         ...
                         $currentData = "'$cuD'" .' '."'00:00:00'";
                          $sql2="SELECT `salon_id`,st_users.online_booking, st_users.allow_online_booking,
                           DATE_ADD(`st_users`.`created_on`,
                            ...
                            WHERE `st_favourite`.`salon_id` = $user->id HAVING (endTrial > $currentData OR (online_booking='1' AND allow_online_booking='true'))";
