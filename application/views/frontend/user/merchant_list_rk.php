    ...
    <section class="clear service_listing_section1 clear <?php echo $cls; ?>">
      <div class="container mt-30">
		 <input type="hidden" id="serchSiburb" value="">
     	 <input type="hidden" id="ser_id" value="Amreen Test Filter">
        	 <input type="hidden" id="catert_id" value="22">
          <div class="row">			 
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="left-side-search">
                  ...
                  <h4 class="color333 font-size-16 fontfamily-medium"><?php echo $this->lang->line(
                      'Map-View'
                  ); ?></h4>
                  <div id="" class="relative mb-30">
                     <a href="#" class="image-map-link d-block" id="image-map-link">
                        <div class="image-map" id="map1"></div>
                       <div class="image-label fontfamily-medium" id="showOnMap" data-ids=""><?php echo $this->lang->line(
                           'Show-salons-on-map'
                       ); ?></div> 
                  ...
                  <div class="row">
                    ...
                    <div class="order-1 order-sm-1 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      ...
                      <input type="hidden" name="category" value="<?php if (
                          isset($_GET['category'])
                      ) {
                          echo $_GET['category'];
                      } ?>">
                      ...
                      <div class="form-group relative">
                        <div class=""><span style="z-index: 3;" class="location-icon-two absolute"></span><span style="left: 35px;top: 10px;z-index: 3;" class="absolute fontfamily-light color666 font-size-12 mb-0 color999"><?php echo $this->lang->line(
                            'Search-distance'
                        ); ?></span></div>
                        <div class="btn-group multi_sigle_select"> 
                          ...
                          class="btn btn-default dropdown-toggle mss_sl_btn color999" style="padding-left:164px !important;color:#999 !important;text-align: center!important;font-size:12px !important;text-transform: none !important"><?php echo $this->lang->line(
                              'Nearby'
                          ); ?></button>
                          <ul class="dropdown-menu mss_sl_btn_dm">
                            <li class="radiobox-image">
                              ...
                              <label for="id_1d"><?php echo $this->lang->line(
                                  'Near-me'
                              ); ?></label>
                            </li>
                            <?php
                            ...
                            <li class="radiobox-image">
                              <input type="radio" id="id_2<?php echo $i; ?>" name="distance" class="distance" value="<?php echo $d; ?>">
                              <label for="id_2<?php echo $i; ?>"><?php echo $this->lang->line(
    'within'
); ?> <?php echo $d; ?> Km</label>
                            </li>
                            <?php $i++;}
                      ...
                      <div class="form-group date_pecker1 relative">
                        ...
                        <div class="calender-date-custume relative around-15" id="datadate"> 
                          ...
                          <div class="row mb-20 relative">
                            ...
                            <div class="col-6">
                              <input type="button" class="calender-btn d selectTTA" placeholder="Heute" value="Heute" data-val="<?php echo date(
                                  'd-m-Y'
                              ); ?>" id="today">
                            </div>
                            ...
                            <div class="col-6" style=" margin-top: 15px;">
                               ...
                               z-index:5 !important;" class="calender-btn d datepicker selectTTA" id="clickheight" placeholder="Datum wählen" value="Datum wählen">
                            </div>
                             <div class="col-6" style=" margin-top: 15px;">
                              <input type="button" class="calender-btn d selectTTA" placeholder="Morgen" value="Morgen" data-val="<?php echo date(
                                  'd-m-Y',
                               ...
                               <button type="button"  class="btn mt-20 submitdate_time"><?php echo $this->lang->line(
                                   'Done'
                               ); ?></button>
                                      ...
                                      while ($tNow <= $tEnd) { ?>
                                            <li class="radiobox-image">
                                              <input class="s <?php if (
                                                  ...
                                                  echo 'schecked';
                                              } ?>" type="radio"  id="from_<?php echo date(
    'H:i',
    $tNow
); ?>"  name="starttime" value="<?php echo date('H:i', $tNow); ?>" <?php if (
    $start_tm == date('H:i', $tNow)
) {
    echo "checked='checked'";
} ?>>
                                              <label for="from_<?php echo date(
                                                  'H:i',
                                                  $tNow
                                              ); ?>"><?php echo date(
    'H:i',
                                      ...
                                      while ($tNow <= $tEnd) { ?>
                                            <li class="radiobox-image">
                                              <input class="s <?php if (
                                                  ...
                                                  echo 'echecked';
                                              } ?>" type="radio"  id="to_<?php echo date(
    'H:i',
    $tNow
); ?>"  name="endtime" value="<?php echo date('H:i', $tNow); ?>" <?php if (
    $end_tm == date('H:i', $tNow)
) {
    echo "checked='checked'";
} ?>>
                                              <label for="to_<?php echo date(
                                                  'H:i',
                                                  $tNow
                                              ); ?>"><?php echo date(
    'H:i',
                    ...
                    <div class="d-flex mt-3">
                      <div class="checkbox mt-0 mb-0">
                        <label class="font-size-14 pl0 color666">
                         <input type="checkbox" name="sucatgory[]" class="checkboxcat" value="<?php
  echo $cat->id;
?>" <?php
if((!empty($_GET['cid']) && $cat->id==url_decode($_GET['cid'])) ||(!empty($_GET['category']) && $cat->parent_id==url_decode($_GET['category']))) echo "checked";
?>>
                         <input type="checkbox" name="sucatgory[]" class="checkboxcat" value="<?php
 echo $cat->cat_id;
?>" <?php
if(!empty($_GET['cid']) && $cat->id==url_decode($_GET['cid'])) echo "checked";
?>>
...
?>
                      ...
                      <span class="ml-auto color999 font-size-14 fontfamily-regular"> <?php
// echo $cat->totalcount;
?>
                     </span>
                    ...
                    <?php
} } else echo "No listing yet."
?>
                  </div>

                  <div class="pt-30 pb-30 border-b">
                    <h4 class="color333 font-size-16 fontfamily-medium mb-20"><?php echo $this->lang->line(
                        'Price-Range'
                    ); ?></h4>
                    <div class="relative">
                    ...
                    <h4 class="color333 font-size-16 fontfamily-medium mb-20"><?php echo $this->lang->line(
                      ...
                      <div class="checkbox mt-0 mb-0">
                          <label class="fontsize-14 pl0 color666 fontfamily-medium mb-1">
                            ...
                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                           <i class="far fa-clock mr-1"></i> <?php echo $this->lang->line(
                               'Express-offers'
                           ); ?>
                          </label>
                ...
                <div class="right-side-search">
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-5 col-lg-6 col-xl-5">
                      <div class="btn-group multi_sigle_select"> 
                          ...
                          <button data-toggle="dropdown" class="btn btn-default dropdown-toggle mss_sl_btn color999 font-size-14" style="font-size:14px!important;color:#999 !important;"><?php echo $this->lang->line(
                              'Sortby'
                          ); ?></button>
                          <ul class="dropdown-menu mss_sl_btn_dm">
                            <li class="radiobox-image">
                              <input type="radio" id="id_1" name="order_by" class="order_by" value="rating desc">
                              <label for="id_1"><?php echo $this->lang->line(
                                  'Highest-Rated'
                              ); ?></label>
                            </li>
                            <li class="radiobox-image">
                              <input type="radio" id="id_2" name="order_by" class="order_by" value="rating asc">
                              <label for="id_2"><?php echo $this->lang->line(
                                  'Lowest-Rated'
                              ); ?></label>
                            </li>
                             <li class="radiobox-image">
                              <input type="radio" id="idc_3" name="order_by" class="order_by" value="distance asc">
                              <label for="idc_3"><?php echo $this->lang->line(
                                  'Closest-Location'
                              ); ?></label>
                            </li>
                            <li class="radiobox-image">
                              <input type="radio" id="idc_4" name="order_by" class="order_by" value="totalcount desc">
                              <label for="idc_4"><?php echo $this->lang->line(
                                  'Most-Reviews'
                              ); ?></label>
                            </li>
                          </ul>
                  ...
                  <!-- first end -->
                   <div id="all_listing"> 
                     ...
                     <?php
// if($sucategory){
//foreach($sucategory as $val){
?>
                    <!-- <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">

                        <h3 class="fontfamily-medium font-size-20 color333" style="cursor:pointer;"> <?php
//echo  $val->business_name;
?></h3>
                        ...
                        <div class="d-flex">
                          <span style="font-size:17px;color: #FF9944;" class="mani_stars_count">0 &nbsp;</span>                                     <svg class="svg-inline--fa fa-star fa-w-18 colore99999940 mr-2 font-size-16" aria-hidden="true" data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"></path></svg>
                           <i class="fas fa-star colore99999940 mr-2 font-size-16"></i> 
                                                                   ...
                                                                   <i class="fas fa-star colore99999940 mr-2 font-size-16"></i>
                                                                   <svg class="svg-inline--fa fa-star fa-w-18 colore99999940 mr-2 font-size-16" 
 ...
 <!-- SHOW map view -->   
  ...
  <div class="modal-dialog modal-lg width1100 modal-dialog-centered" role="document">    
    <div class="modal-content">      
     <a href="#" class="crose-btn-blue" data-dismiss="modal">
        <img src="<?php echo base_url(
            'assets/frontend/'
        ); ?>images/popup_crose_white_icon.svg" class="popup-crose-white-icon">
      </a>
  ...
  <div class="modal-dialog modal-md modal-dialog-centered" role="document">    
    <div class="modal-content text-center">      
      ...
      <picture class="">
        <source srcset="<?php echo base_url(
            'assets/frontend/images/popup-registeri-user-icon.webp'
        ); ?>" type="image/webp">
        <source srcset="<?php echo base_url(
            'assets/frontend/images/popup-registeri-user-icon.svg'
        ); ?>" type="image/svg">
        <img src="<?php echo base_url(
            'assets/frontend/images/popup-registeri-user-icon.svg'
        ); ?>">
        ...
        <?php } else { ?>
          <a href="<?php echo base_url(
              'auth/login'
          ); ?>"><button type="button" class=" btn btn-large widthfit">Einloggen / Registrieren</button></a>
          <?php } ?>
      </div>
    </div>
  </div>
...
console.log("streets================ lat lon",map1)
    ...
    <script>
      var url = base_url+"listing/getUserdetailsmy";
      $.ajax(
    {
        type: "POST",
        url: url,
        data: {"ser_id":ser_id,'catert_id':catert_id}
    ...
    //  $.post(base_url+"listing/getUserdetailsmy",$("#serch_form").serialize(),function(data){
    ...
    //         if(obj.success=='1'){
		...
		// 			}
		// 		else{
		// 			  $("#saloneCountText").html(obj.count+" <?php echo $this->lang->line(
      'salons-found'
  ); ?>");
		// 			}
		// 		//addanchoreUrl		
  ...
  var sch_add = "<?php echo !empty($_GET['address'])
      ? $_GET['address']
      : ''; ?>"; 
