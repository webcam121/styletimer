          ...
          <div class="row">			 
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="left-side-search">
                  ...
                  <h4 class="color333 font-size-16 fontfamily-medium"><?php echo $this->lang->line('Map-View'); ?></h4>
                  ...
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <div class="form-group relative">
                        <div class="location-icon absolute"></div>
                           ...
                           value="<?php if(isset($_GET['address'])) echo $_GET['address'];  ?>" placeholder="Ort" class="form-control pl-28">
                  	       <span class="reset display-n">
                           <picture class="">
                            <source srcset="<?php echo base_url('assets/frontend/images/popup_crose_black_icon.webp'); ?>" type="image/webp" class="">
                            <source srcset="<?php echo base_url('assets/frontend/images/popup_crose_black_icon.png'); ?>" type="image/png" class="">
                    ...
                    <div class="order-1 order-sm-1 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      <input type="hidden" name="lat" value="<?php if(isset($_GET['lat'])) echo $_GET['lat'];  ?>" id="lat">
                      <input type="hidden" name="lng" value="<?php if(isset($_GET['lng'])) echo $_GET['lng']; ?>" id="lng">
                      ...
                      ?>">
                      <input type="hidden" name="filtercat" value="<?php if(isset($_GET['filtercat'])) echo $_GET['filtercat']; ?>">                      
                      ...
                      <div class="form-group relative">
                        <div class=""><span style="z-index: 3;" class="location-icon-two absolute"></span><span style="left: 35px;top: 10px;z-index: 3;" class="absolute fontfamily-light color666 font-size-12 mb-0 color999"><?php echo $this->lang->line('Search-distance'); ?></span></div>
                        <div class="btn-group multi_sigle_select"> 
                             <?php $distance=array('0.2','0.5','1','3','5','10','20'); ?>

                          <button data-toggle="dropdown" 
                          class="btn btn-default dropdown-toggle mss_sl_btn color999" style="padding-left:164px !important;color:#999 !important;text-align: center!important;font-size:12px !important;text-transform: none !important"><?php echo $this->lang->line('Nearby'); ?></button>
                          <ul class="dropdown-menu mss_sl_btn_dm">
                            <li class="radiobox-image">
                              <input type="radio" id="id_1d" name="distance" 
                              class="distance" value="5">
                              <label for="id_1d"><?php echo $this->lang->line('Near-me'); ?></label>
                            </li>
                            <?php
                            //print_r($distance);
                            $i=0; foreach($distance as $d){ ?>
                            <li class="radiobox-image">
                              <input type="radio" id="id_2<?php echo $i; ?>" name="distance" class="distance" value="<?php echo $d; ?>" <?php echo $d == '20' ? 'checked="checked"':''?>>
                              <label for="id_2<?php echo $i; ?>"><?php echo $this->lang->line('within'); ?> <?php echo $d; ?> Km</label>
                            </li>
                            <?php $i++; } ?>
                          </ul>
                        </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-2">
                      <div class="form-group date_pecker1 relative">
                        ...
                        id="setDateFilter"  placeholder="Date" 
                        value="<?php echo $dates; ?>" autocomplete="off" style="background-color:#fff;" readonly>
                        ...
                        <div class="calender-date-custume relative around-15" id="datadate"> 
                          ...
                          <div class="row mb-20 relative">
                            <div class="col-6">
                              ...
                              <input type="button" class="calender-btn d selectTTA" placeholder="Beliebig" value="Beliebig" data-val="Beliebig" id="anydate">

                            </div>
                            
                            <div class="col-6">
                              <input type="button" class="calender-btn d selectTTA" placeholder="Heute" value="Heute" data-val="<?php echo date("d-m-Y") ?>" id="today">
                            </div>
                 
                            
                            <div class="col-6" style=" margin-top: 15px;">
                               <input type="button" class="calender-btn d datepicker"
                             ...
                             <div class="col-6" style=" margin-top: 15px;">
                              <input type="button" class="calender-btn d selectTTA" placeholder="Morgen" value="Morgen" data-val="<?php echo date('d-m-Y',strtotime("+1 day", strtotime(date("d-m-Y"))));  ?>" id="tomorrow" >
                            </div>
                          </div>
                      ...
                      <div class="form-group  time_pecker1">
                         <?php
                          if(isset($_COOKIE['sch_time']) && $_COOKIE['sch_time'] !='')
                              ...
                              $times= 'Beliebig';
                         ?>
                        <input class="pl-35 form-control vinu_style_time tim" 
                        placeholder="Time" name="time" 
                        id="selctTimeFilter" 
                        value="<?php echo  $times;?>" autocomplete="off" 
                        ...
                        <div class="time-custume relative around-15" id="timedata"> 
                          ...
                          <div class="row mb-20" >
                            <div class="col-6">
                              ...
                              placeholder="Beliebig" value="Beliebig">

                            </div>
                            <div class="col-6">
                              <input type="button" class="calender-btn t" id="clicktimeheight" placeholder="Zeit wählen" 
                              value="Zeit wählen">                              
                            </div>
                            <div class="col-6">
                            ...
                            <label>Von</label>    							  
                                <div class="btn-group multi_sigle_select inp_select">  
                                  ...
                                  class="btn btn-default dropdown-toggle mss_sl_btn"><?php echo $shwStime; ?>
                                     ...
                                     style="max-height: none; overflow-x: auto; height: 150px !important;
                                position: absolute; transform: translate3d(0px, 40px, 0px); 
                                top: 0px; left: 0px; will-change: transform;" x-placement="bottom-start">
                                      <?php   if(!empty($minmaxtime->mintime)){
												...
												while($tNow <= $tEnd){ ?>
                                            <li class="radiobox-image">
                                              <input class="s <?php if($start_tm=='From' && date("H:i",$tNow)=='08:00') echo 'schecked'; ?>" type="radio"  id="from_<?php echo date("H:i",$tNow); ?>"  name="starttime" value="<?php echo date("H:i",$tNow); ?>" <?php if($start_tm==date("H:i",$tNow)){ echo"checked='checked'"; } ?>>
                             ...
                             ?>
                              <div class="time_picker_droupdown w-100 ml-0">
                                ...
                                <div class="btn-group multi_sigle_select inp_select"> 
                                  ...
                                  <button data-toggle="dropdown" class="btn btn-default dropdown-toggle mss_sl_btn"><?php echo $showEtime; ?></button>
                                ...
                                top: 0px; left: 0px; will-change: transform;" x-placement="bottom-start">
                                      <?php   if(!empty($minmaxtime->mintime)){
												...
												while($tNow <= $tEnd){ ?>
                                            <li class="radiobox-image">
                                              <input class="s <?php if($end_tm=='To' && date("H:i",$tNow)=='20:00') echo 'echecked'; ?>" type="radio"  id="to_<?php echo date("H:i",$tNow); ?>"  name="endtime" value="<?php echo date("H:i",$tNow); ?>" <?php if($end_tm==date("H:i",$tNow)){ echo"checked='checked'";} ?>>
                          ...
                          <button class="btn mt-20 closeTime"  type="button"><?php echo $this->lang->line('Done'); ?></button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="mobile-btn-show" href="#jump">
                    <button type="button" class="btn btn-border-orange border-radius4 widthfit1 mobile-show-col colororange">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#FF9944">
                        <path fill="#FF9944" class="Button--button--242502 Button--medium--3861b1 Button--outlineBlue--6d4b33" d="M10 17v-1.01c0-.546.444-.99 1-.99a1 1 0 0 1 1 .99v4.02c0 .546-.444.99-1 .99a1 1 0 0 1-1-.99V19H2v-2h8zm5-6V9.99c0-.546.444-.99 1-.99a1 1 0 0 1 1 .99v4.02c0 .546-.444.99-1 .99a1 1 0 0 1-1-.99V13H2v-2h13zM5 5V3.99C5 3.445 5.444 3 6 3a1 1 0 0 1 1 .99v4.02C7 8.555 6.556 9 6 9a1 1 0 0 1-1-.99V7H2V5h3zm4 0h13v2H9V5zm10 6h3v2h-3v-2zm-5 6h8v2h-8v-2z"></path></svg>
                    ...
                    <?php if(!empty($sucategory)){ 
						//echo '<pre>'; print_r($sucategory); die;
						        foreach($sucategory as $cat){ ?>
    									<?php if ($cat->totalcount > 0 || (!empty($_GET['cid']) && $cat->id==url_decode($_GET['cid']))) : ?>
                      <div class="d-flex mt-3">
                        <div class="checkbox mt-0 mb-0">
                          <label class="font-size-14 pl0 color666">
                            <!-- <input type="checkbox" name="sucatgory[]" class="checkboxcat" value="<?php echo $cat->id; ?>" <?php if((!empty($_GET['cid']) && $cat->id==url_decode($_GET['cid'])) ||(!empty($_GET['category']) && $cat->parent_id==url_decode($_GET['category']))) echo "checked"; ?>> -->
                            <input type="checkbox" name="sucatgory[]" class="checkboxcat" value="<?php echo $cat->id; ?>" <?php if(!empty($_GET['cid']) && $cat->id==url_decode($_GET['cid'])) echo "checked"; ?>>
                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                            <?php echo $cat->category_name; ?>
                          </label>
                        </div>
                        <span class="ml-auto color999 font-size-14 fontfamily-regular subcat-total" catid="<?php echo $cat->id; ?>"> <?php //echo $cat->totalcount; ?> </span>
                      </div>
                      <?php endif; ?>
                    <?php } } else echo "No listing yet." ?>
                  </div>

                  <div class="pt-30 pb-30 border-b">
                    <h4 class="color333 font-size-16 fontfamily-medium mb-20"><?php echo $this->lang->line('Price-Range'); ?></h4>
                    <div class="relative">
                          <div id="test-slider"></div>

                          <small class="small_box_input border-w border-radius4 bgwhite color333 vertical-top display-ib text-center" style="left:0px;" id="startRange">0 €</small> 
                          <small class="small_box_input border-w border-radius4 bgwhite color333 vertical-top display-ib text-center"id="endRange">80 €</small>
                  ...
                  <div class="pt-30 pb-30">
                    <h4 class="color333 font-size-16 fontfamily-medium mb-20"><?php echo $this->lang->line('Express-Treatments'); ?></h4>
                      <div class="checkbox mt-0 mb-0">
                          <label class="fontsize-14 pl0 color666 fontfamily-medium mb-1">
                            ...
                            <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                           <i class="far fa-clock mr-1"></i> <?php echo $this->lang->line('Express-offers'); ?>
                          </label>
                          <span class="fontfamily-regular font-size-14 color999 display-b ml-50">(nächste 2 Stunden oder weniger)</span>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-5 col-lg-6 col-xl-5">
                      <div class="btn-group multi_sigle_select"> 
                          ...
                          <button data-toggle="dropdown" class="btn btn-default dropdown-toggle mss_sl_btn color999 font-size-14" style="font-size:14px!important;color:#999 !important;"><?php echo $this->lang->line('Sortby'); ?></button>
                          <ul class="dropdown-menu mss_sl_btn_dm">
                            <li class="radiobox-image">
                              <input type="radio" id="id_1" name="order_by" class="order_by" value="rating desc">
                              <label for="id_1"><?php echo $this->lang->line('Highest-Rated'); ?></label>
                            </li>
                            <li class="radiobox-image">
                              <input type="radio" id="id_2" name="order_by" class="order_by" value="rating asc">
                              <label for="id_2"><?php echo $this->lang->line('Lowest-Rated'); ?></label>
                            </li>
                             <li class="radiobox-image">
                              <input type="radio" id="idc_3" name="order_by" class="order_by" value="distance asc">
                              <label for="idc_3"><?php echo $this->lang->line('Closest-Location'); ?></label>
                            </li>
                            <li class="radiobox-image">
                              <input type="radio" id="idc_4" name="order_by" class="order_by" value="totalcount desc">
  ...
  <div class="modal-dialog modal-lg width1100 modal-dialog-centered" role="document">    
    <div class="modal-content">      
     <a href="#" class="crose-btn-blue" data-dismiss="modal">
        <img src="<?php echo base_url("assets/frontend/"); ?>images/popup_crose_white_icon.svg" class="popup-crose-white-icon">
      </a>
  ...
  <div class="modal-dialog modal-md modal-dialog-centered" role="document">    
    <div class="modal-content text-center">      
      ...
      <picture class="">
        ...
        <p id="addservice_message" class="font-size-18 color333 fontfamily-medium mt-3 mb-30 text-lines-overflow-1" style="padding:5px;">
          <?php 
        ...
        <?php } else {  ?>
          <a href="<?php echo base_url('auth/login'); ?>"><button type="button" class=" btn btn-large widthfit">Einloggen / Registrieren</button></a>
          <?php } ?>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
    ...
    var streets = L.tileLayer.Unwired({key: iq_api_key, scheme: "streets"});
    ...
    var geocoderControl = new L.control.geocoder( iq_api_key, geocoderControlOptions).addTo(map).on('select', function (e) {
        displayLatLon(e.feature.feature.display_place, e.latlng.lat, e.latlng.lng);
    }).on('reset', function (e) {
  ...
  //alert('er');
   ...
   //  $.post(base_url+"listing/getUserdetails",$("#serch_form").serialize(),function(data){
         console.log("----------------",$("#serch_form").serialize())
        $.post(base_url+"listing/getUserdetails",$("#serch_form").serialize(),function(data){
          ...
          if (obj.count == 1) {
            $("#saloneCountText").html(obj.count+" Salon in "+splival[0] + ' gefunden');  
          } else {
            $("#saloneCountText").html(obj.count+" Salons in "+splival[0] + ' gefunden');  
          }
        }
				else{
          if (obj.count == 1) {
            $("#saloneCountText").html(obj.count+" Salon gefunden");
          } else {
            $("#saloneCountText").html(obj.count+" Salons gefunden");
          }
        }
				//addanchoreUrl		
          ...
          services.forEach( function(service){
            $('.subcat-total[catid="' + service.subcat_id + '"]').html(service.user_count)
          })
				unloading();
        //alert('f');
				addanchor_url();
		   ...
		   //console.log(data);
            ...
            if(obj.success=='1'){
				...
				//~ };
				 ...
				 theMarker = new L.marker([locations[i]['latitude'], locations[i]['longitude']],{id: locations[i]['id'],icon:greenIcon}).addTo(map1).on('click',  function(map1) {  });
				...
				theMarkers = new L.marker([locations[i]['latitude'], locations[i]['longitude']],{id: locations[i]['id'],icon:greenIcon}).addTo(map2).on('click', L.bind(changeSlick, null, i));
 ...
 function addanchor_url(){
  ...
  $(".addanchoreUrl").each(function(){
          ...
          var urlParam="";
          if(date!=undefined && date!="" && date!="Beliebig"){
            urlParam='&date='+date;
            }
          ...
          if(sids!=undefined && sids!=""){
            $("#"+id).attr('href',href+"?servicids="+sids+urlParam);  //window.location.href=href+"?servicids="+sids+urlParam;
          }
          else{
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','.open_time_dropdown',function(){
       ...
       var status = localStorage.getItem('STATUS');
		...
		loading();
		//alert(uid);
	 $.post(base_url+"listing/get_merchant_availablity",{uid:uid},function( data ) {
    ...
    if (date1 != 'Beliebig') {
      let tmp = date1.split('.');
      $('.datepicker').datepicker('setDate', tmp[1]+'/'+tmp[0]+'/'+tmp[2]);
    }
   ...
   <script type="text/javascript">
    ...
    $(document).on('click', function (event) {
      ...
      if ($(event.target).closest('#datadate').length) {
       }
      else{
       ...
       if ($(event.target).closest('#timedata').length) {
       }
      else{
...
function viewonmap(uid=''){
	  ...
	  //console.log(data);
	   ...
	   var numItems = $('.popupSlideCount').length;
         ...
         var status = localStorage.getItem('STATUS');
			...
			// }
			console.log('STATUS='+status);
	   $.post(url,data,async function(data){  
		   var obj = jQuery.parseJSON( data );
            if(obj.success=='1'){
				var latlng=[];
				var latLng1="";
              ...
              var latLng1=new L.LatLng(theMarker2[i]._latlng.lat,theMarker2[i]._latlng.lng,{id:uid});
						}else{
				...
				if(uid!='')
				  {
					...
					map2.setZoom(17);
					map2.panTo(latLng1);
					setTimeout(function(){ $('.gmnoprint .gm-control-active').trigger('click');  },1000);
  ...
  $(document).ready(function(){
     ...
     $(document).on('click',".ui-icon-circle-triangle-e",function(){
 	    	setTimeout(function(){ $('#datadate').css('display','block'); }, 50);
...
$(document).ready(function () {
       ...
       $(document).on('click','.favourite_click', function(){
        ...
        //alert(loadid);
        var data = {'salon_id' :sid, 'status' : type};
        loading();  
        $.ajax({
