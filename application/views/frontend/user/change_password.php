    ...
    <section class="pt-120 clear user_profile_section1">
      <div class="container">
        ...
        <?php $this->load->view('frontend/common/alert'); ?>
            <div class="row">
              <div class="col-12 col-sm-12 col-md-6 offset-md-3 col-lg-6 offset-lg-2 col-xl-4 offset-xl-4">
            ...
            <div class="bgwhite box-shadow1 border-radius4 around-30">
              <!-- <p class="fontfamily-regular font-size-14 mb-0 hide-changepassword">
                <a href="#" class="colororange a_hover_orange text-underline a_show-changepassword" id="show-changepassword">CLICK HERE</a> to change your -password *</p> -->
                 ...
                 <div id="succ_msgs" class="alert alert-success absolute vinay top w-100 mt-25">
            ...
            <div class="mt-50 mb-50 text-center">
				<a href="<?php if(!empty($_SERVER['HTTP_REFERER'])) echo $_SERVER['HTTP_REFERER']; ?>"><button type="button" class="btn btn-large widthfit2 mr-4"><?php echo $this->lang->line('abort'); ?></button></a>
