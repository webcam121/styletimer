                ...
                <div class="container">
                    ...
                    <div class="card ">
						...
						<div class="card-header">
                            ...
                            <a href="<?php echo base_url('backend/filter_category/make'); ?>" class="btn btn-primary waves-effect addbtn-p">ADD</a>
                ...
                $("#data-table-command").bootgrid({
                    ...
                    formatters: {
                        "commands": function(column, row) {
							 //console.log(column);
							 console.log(row);
                            return "<button type=\"button\" class=\"btn btn-icon command-edit\" onclick=\"EditRow(" + row.rowid + ",'backend/filter_category/make/')\" data-row-id=\"" + row.rowid + "\"><span class=\"zmdi zmdi-edit\"></span></button> " + 
                                "<button type=\"button\" class=\"btn btn-icon command-delete\" onclick=\"DeleteRow(" + row.rowid + ",'backend/filter_category/delete/')\" data-row-id=\"" + row.rowid + "\"><span class=\"zmdi zmdi-delete\"></span></button>";
                        }
                    }
                });
            });
