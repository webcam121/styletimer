            ...
            <section id="content">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                            <h2 style="display: inline-block;">Privacy Policy <?php echo ucfirst($segment3); ?></h2>
                    ...
                    <form id="static_frm" method="post" action="">    
                      <div class="fg-line form-group">
                        ...
                        <input type="text" class="form-control input-sm" id="title_name" name="title_name" placeholder="Enter privacy policy title" value="<?php echo isset($terms->title)?$terms->title:''; ?>">
