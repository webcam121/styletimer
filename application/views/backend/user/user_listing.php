  ...
  <section id="content">
                <div class="container">
                    <div class="block-header">
                        <h2>User - Listing from dashboard</h2>
                    </div>
                    ...
                    <div class="card">
                      ...
                      <div class="col-sm-3 m-b-15 text-right"><a href="<?php echo base_url('backend/dashboard').$get_data; ?>"><button class="btn btn-info waves-effect">Go Back</button></a></div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="input-group form-group">
                            ...
                            <div class="dtp-container fg-line">
                                <input type="text" id="start_date" style="padding-left: 10px;" class="form-control date-picker" name="start_date" value="<?php echo isset($_GET['start_date'])?$_GET['start_date']:''; ?>" placeholder="select start date">
                            </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="dtp-container fg-line">
                                <input type="text" id="end_date" style="padding-left: 10px;" class="form-control date-picker" name="end_date" value="<?php echo isset($_GET['end_date'])?$_GET['end_date']:''; ?>" placeholder="select end date">
                            </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="first_name" data-order="asc" data-type="string" >Name</th>
                                     <th data-column-id="mobile" data-type="string">Created On</th>
                                    <th class="text-center" data-column-id="t_booking">Total Booking</th>
                                    <th class="text-center" data-column-id="cmp_booking">Completed Booking</th>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                /* $(document).on('change','.on_change_short', function(){
                        var limit=$(this).val();
                        var url=base_url+"backend/dashboard/user_listing?short="+limit;
                 ...
                 $(document).on('change','.on_change_short', function(){
                   ...
                   $(document).on('click','#click_search', function(){
                        ...
                        if(end ==""){
                            ...
                            $('#error_end').html('');
                        if(tokan == true){
                            var url=base_url+"backend/dashboard/user_listing?start_date="+start+"&end_date="+end;
                            window.location.href = url;
                        }
                   });
