                    ...
                    <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                      <div class="relative p-1 text-center mb-30">
                       ...
                       <?php if(!empty($userdata->profile_pic)){ ?> 
                        <img src="<?php echo base_url('assets/uploads/users/'.$userdata->id.'/thumb_'.$userdata->profile_pic); ?>" class="round-new-v80 ">
                        <?php }else{ ?>
                    ...
                    <div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
                      <div class="relative">
                         <div class="display-ib"> 
                          <h5 class="font-size-16 colorcyan fontfamily-medium display-ib mt-1"><?php echo ucfirst($userdata->first_name); ?> </h5>
                        ...
                        <div class="display-ib float-right mb-3 relative" style="z-index:999;clear:both;">
                          <div class="dropdown">
                              ...
                              <div class="dropdown-menu show" aria-labelledby="dropdownMenuButton11" x-placement="bottom-start" style="">
                                ...
                                <a data-status="<?php echo $stt; ?>" class="dropdown-item" href="#" onClick="changeUserstatus(<?php echo $userdata->id; ?>);" id="change_user_status" data-uid="<?php echo $userdata->id; ?>"><?php echo $st; ?></a>
                                <input type="hidden" id="user_status_change" value="<?php echo $stt; ?>" name="">
                ...
                <div class="row h-85">
                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                      <div class="bgwhite border-radius4 box-shadow1 h-100 px-3">
                        <select id="" class="searchNewFilteruser">                         
                ...
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                  <div class="pt-20 pb-20 pl-30 pr-20 relative d-flex appoin-listing-filter">
                      ...
                      <!--  <span class="color999 fontfamily-medium font-size-14">Status</span> -->
                        <select id="over_all_filter_c" class="on_change_short_u">
                          ...
                          <div class="col-md-6">
                            <div id="date_section_u" style="display: none;">
                              <div class="col-sm-5">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <table class="table" id="listingTabl" data-uid="<?php echo url_encode($userdata->id); ?>">
                        <thead>
                          <tr>
                            <th class="text-center height56v"><a href="javascript:void(0)" class="color333 shorting_user" id="booking_time" data-short="desc">DATE 
                            ...
                            <th class="text-center height56v">TIME
                             ...
                             <th class="text-center height56v">Salon name
                            </th>
                            
                            <th class="text-center height56v"><a href="javascript:void(0)" class="color333 shorting_user" id="id" data-short="desc">BOOKING ID
                              <div class="display-ib vertical-middle ml-1">
                                <img src="<?php echo base_url('assets/frontend/images/caret-arrow-up.png'); ?>" class="display-b " style="width:8px;"> 
                                <img src="<?php echo base_url('assets/frontend/images/sort-down.png'); ?>" class="display-b " style="width:8px;"> 
                              </div></a>
                            ...
                            <th class="text-center height56v"><a href="javascript:void(0)" class="color333 shorting_user" id="total_minutes" data-short="desc">DURATION
                              <div class="display-ib vertical-middle ml-1">
                                <img src="<?php echo base_url('assets/frontend/images/caret-arrow-up.png'); ?>" class="display-b " style="width:8px;"> 
                                <img src="<?php echo base_url('assets/frontend/images/sort-down.png'); ?>" class="display-b " style="width:8px;"> 
                              </div></a>
                            ...
                            <th class="text-center height56v"><a href="javascript:void(0)" class="color333 shorting_user" id="total_price" data-short="desc">PRICE
                              <div class="display-ib vertical-middle ml-1">
                                <img src="<?php echo base_url('assets/frontend/images/caret-arrow-up.png'); ?>" class="display-b " style="width:8px;"> 
                                <img src="<?php echo base_url('assets/frontend/images/sort-down.png'); ?>" class="display-b " style="width:8px;"> 
                              </div></a>
