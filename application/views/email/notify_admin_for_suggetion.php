    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          There is a new suggestion for site inprovement.</p>
          <?php if(isset($salonname)){ ?><p>salon name : <?php echo $salonname; ?></p> <?php } ?>
           <?php if(isset($message)){ ?><p>Message : <?php echo $message; ?></a><?php } ?>
