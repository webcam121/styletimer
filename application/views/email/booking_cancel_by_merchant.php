      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            Deine Buchung bei <?php echo $salon_name; ?> wurde vom Salon storniert. <br/>
            Falls du denkst, dass es sich hierbei um ein Versehen handelt, kontaktiere <?php echo $salon_name; ?>. <br/>
          </p>
