    ...
    <table style="width:600px;background: #fff;margin:0 auto;font-family: 'arial', sans-serif">
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;color:black; font-weight:500;margin-top:5px; ">Hallo <?php echo $name; ?>,</p>
          <p style="font-size: 16px;color:black; font-weight:500;line-height: 20px;">wir bedauern, dass du dein Konto bei styletimer löschen möchtest. Mit dem nachfolgenden Code kannst du die vollständige Löschung deines Accounts und aller dazugehörigen Daten bestätigen: <br/><br/><br/>
          <?php if(isset($otp)){ echo $otp; } ?>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:27px; ">Wir wünschen dir einen schönen Tag!</p>
          <span style="font-size: 16px;font-weight:500;color:#333; ">Beste Grüße,</span>
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:0px;margin-bottom:35px; ">dein Team von styletimer</p>
        </td>
      </tr>
      <tr>
