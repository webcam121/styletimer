  ...
  <table style="width:600px;background: #fff;margin:0 auto;font-family: 'arial', sans-serif">
    ...
    <tr>
      <td style="padding:0px 30px;">
        <p style="font-size: 20px;color:#333;font-weight:500;line-height: 30px; ">Hello Admin, <br />There is a new salon request</p>
      </td>
    </tr>
    <tr>
      <td style="padding:20px 30px 20px;border-top:1px solid #e8e8e8;">
        <table style="">
          <tr>
            ...
            <td>
              <p style="margin-top:0px;margin-bottom:0px;"><span>Name : </span> <?php echo $data['name']; ?></p>
              <p style="margin-top:0px;margin-bottom:0px;"><span>Name of salon : </span> <?php echo $data['salon_name']; ?></p>
              <p style="margin-top:0px;margin-bottom:0px;"><span>City of salon : </span> <?php echo $data['salon_city']; ?></p>

              <?php

              if (isset($data['email']) && !is_null($data['email'])) {
                echo '<p style="margin-top:0px;margin-bottom:0px;"><span>Email : </span>' . $data['email'] . '</p>';
              }
              ?>
              <!--
                <p style="margin-top:0px;margin-bottom:0px;"><span>Date & Time : </span> <?php echo date('Y-m-d H:i', strtotime($data['date'])); ?></p>
-->
            </td>
          </tr>
