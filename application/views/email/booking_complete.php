      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 16px;font-weight:500;line-height: 30px; ">
            Deine Buchung bei <?php echo $salon_name; ?> wurde erfolgreich abgeschlossen! <br>
          </p>
        </td>
      </tr>      
      <tr>
        <td style="padding:0px 30px; margin-top: 20px;">
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            Bitte bewerte deinen Besuch <?php echo $salon_name; ?>
          </p>
          ...
          <?php if(isset($bookid))
           ...
           ?>
          <p style="font-size: 16px;font-weight:500;line-height: 20px;">
            <a style="color:#00b3bf;" href="<?php echo base_url('home/booking_redirect/').$bookid; ?>">
              <img style="margin-bottom: 5px; width: 192px; height: 36px;" src="<?php echo base_url('assets/frontend/images/review_5.png'); ?>">
              <br/>
              <span>Jetzt Bewertung abgeben</span>
            </a></p>
          <?php //echo base_url('user/all_bookings'); ?>
        </td>
      </tr>
      <tr>
        <td style="padding:0px 30px;">
