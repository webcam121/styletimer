    ...
    <table style="width:600px;background: #fff;margin:0 auto;font-family: 'arial', sans-serif">
      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          <p style="font-size: 16px;font-weight:500;line-height: 20px;">du hast ein neues Passwort angefordert.</p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px;">Mit einem Klick auf den Button kannst du ein neues Passwort für deinen Account festlegen.</p>
        <?php if(isset($link)){ ?>
          <a href="<?php echo $link; ?>" class="" style="border-radius: 4px;height:40px;width:170px;line-height: 40px;color: #fff;font-weight:500;font-size: 16px;background:#46a6b1;display: block;text-decoration: none;text-align: center;margin:0 auto;">Passwort zurücksetzen</a>
          <?php } ?>
        </td>
      </tr>
      <tr>
