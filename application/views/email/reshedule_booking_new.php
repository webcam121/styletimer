    ...
    <?php /* <tr>
      ...
      <tr style="border-bottom:1px solid #e8e8e8;">
        <td style="padding:0px 30px;">
          <p  style="font-size: 16px;font-weight:500;line-height: 30px; ">Deine Buchung bei <?php if(!empty($main[0]->business_name)) echo $main[0]->business_name; ?> wurde erfolgreich verlegt.<br/> Hier die Details deiner Buchung: <br/></p>
        </td>
      </tr>      
      <tr>
