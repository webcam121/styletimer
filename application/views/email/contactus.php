    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 20px;color:#333;font-weight:500;line-height: 30px; ">Hello Admin, <br/>There is a new contact</p>
        </td>
      </tr>      
      <tr>
          ...
          <table style="">
            <tr>
              ...
              <td>
                ...
                <p style="margin-top:0px;margin-bottom:0px;"><span>Email : </span> <?php echo $data['email']; ?></p>
                <p style="margin-top:0px;margin-bottom:0px;"><span>Subject : </span> <?php echo $data['subject']; ?></p>
                <p style="margin-top:0px;margin-bottom:0px;"><span>Message : </span> <?php echo $data['message']; ?></p>
