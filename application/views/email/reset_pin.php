    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 16px;color:#333;font-weight:500;line-height: 30px; ">Hallo <?php echo $username; ?>, <br/>Wir haben einen neuen PIN für dich generiert.</p>
        </td>
      </tr>      
      <tr>
        <td style="padding:20px 30px 20px;border-top:1px solid #e8e8e8;">
          <table style="">
            <tr>
              ...
              <td>
                <p style="font-size: 16px;margin-top:0px;margin-bottom:0px;"><span>PIN : </span> <?php echo $pin; ?></p>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:27px; ">Viel Spaß bei der Verwaltung deines Salons!</p>
          <span style="font-size: 16px;font-weight:500;color:#333; ">Beste Grüße,</span>
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:0px;margin-bottom:35px; ">dein styletimer-Team</p>
        </td>
      </tr>
      <tr>
