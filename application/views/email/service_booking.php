...
table{
  ...
  <?php if(!empty($booking_detail)){ 
    ...
    <?php /* <tr>
      ...
      <tr style="border-bottom:1px solid #e8e8e8;">
        <td style="padding:0px 30px;">
          <p  style="font-size: 16px;font-weight:500;line-height: 30px; ">
            ...
            <br/>Wir wünschen dir viel Spaß bei <?php if(!empty($main[0]->business_name)) echo $main[0]->business_name; ?>!<br/>
          </p>
        </td>
      </tr>      
      <tr>
        <td style="padding:20px 30px 20px;border-top:1px solid #e8e8e8;">
          <table style="">
            <tr>
              ...
              <td>
                <p style="margin-top:0px;font-size: 16px;margin-bottom:0px;"><span><?php echo $this->lang->line('By'); ?> : </span> <?php echo $main[0]->first_name; ?></p>
                <p style="margin-top:0px;font-size: 16px;margin-bottom:0px;"><span><?php echo $this->lang->line('Date'); ?> : </span> <?php echo $date; ?></p>
                <p style="margin-top:0px;font-size: 16px;margin-bottom:0px;"><span><?php echo $this->lang->line('Time'); ?> : </span> <?php echo $time; ?> Uhr</p>
                <p style="margin-top:0px;font-size: 16px;margin-bottom:0px;"><span><?php echo $this->lang->line('Booking_Id'); ?> : </span> <a style="color:#00b3bf;" href="<?php echo base_url('home/booking_redirect/').url_encode($main[0]->id); ?>"><?php if(!empty($main[0]->book_id)) echo $main[0]->book_id; else echo $main[0]->id; ?></a> </p>
      ...
      <tr>
        <td style="padding:20px 0px 0px;border-bottom:1px solid #e8e8e8;">
          <table style="width: 100%;">
            <thead>
              <tr style="border-bottom:  1px solid #e8e8e8;">              
                <th style="text-align: left;font-size: 16px;border-bottom:1px solid #e8e8e8;padding-left:30px;"><?php echo $this->lang->line('service'); ?> </th>
                <th style="text-align: left;font-size: 16px;border-bottom:1px solid #e8e8e8;">Dauer </th>
                <th style="text-align: left;font-size: 16px;border-bottom:1px solid #e8e8e8;"><?php echo $this->lang->line('Discount1'); ?> </th>
                <th style="text-align: left;font-size: 16px;border-bottom:1px solid #e8e8e8;padding-right:30px;"><?php echo $this->lang->line('Price1'); ?> </th>
              </tr>
            </thead>
            <body>
            <?php $min=$dis=$prc=0;$ab='';
              ...
              <tr style="">
                <td style="text-align: left;font-size: 16px;color:#666;font-weight: 500;padding:15px 0px 10px 30px; ">enthaltener Rabatt</td>
      ...
      <tr>
        <td style="padding:25px 20px 10px 30px;"><span style="font-weight:500 ;font-size: 16px; ">
          <h4><b>Kundennotiz <?php if(!empty($main[0]->business_name)) echo $main[0]->business_name.':'; ?></b></h4>
          <?php
