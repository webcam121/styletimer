    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          Your appointment with <?php echo $salon_name; ?> has been marked as noshow. If you want to again book the new service then please visit our website.</p>
          <?php if(isset($booking_id)){ ?><p>Booking Id : <a href="<?php echo base_url('home/booking_redirect/').url_encode($booking_id); ?>"><?php echo $booking_id; ?></a></p> <?php } ?>
