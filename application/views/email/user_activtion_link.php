    ...
    <table style="width:600px;background: #fff;margin:0 auto;font-family: 'arial', sans-serif">
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 16px;font-weight:500;line-height: 30px; font-weight: bold;"> 
            Noch ein Klick und du bist startklar!
          </p>
        </td>
      </tr>      
      <tr>
        <td style="padding:0px 30px;">
          ...
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">herzlich Willkommen bei styletimer.</p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            Wir freuen uns riesig, dass du mit dabei bist! <br/><br/>
            Mit styletimer buchst und verwaltest du deine Termine ab sofort wo und wann immer du möchtest. <br/><br/>
            Aktiviere jetzt deinen Account und entdecke deinen Style - in einer App!
          </p>
        <?php if(isset($link)){ ?>
