      ...
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;margin-top:5px; ">
            Hi <?php echo $main[0]->first_name; ?>,
          </p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            <?php echo $main[0]->business_name; ?> hat einen neuen Termin für dich erstellt.<br/>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 0px 30px;">
          ...
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><span>Service : </span> <?php echo $booking_detail[0]->service_name;?> </p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><span><?php echo $this->lang->line('Date'); ?> : </span> <?php echo date('d.m.Y', strtotime($date)); ?></p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><span><?php echo $this->lang->line('Time'); ?> : </span> <?php echo $time; ?> Uhr</p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><span>Dauer : </span> <?php if(!empty($main[0]->total_time)) echo $main[0]->total_time; else '-'; ?> Min.</a> </p>
