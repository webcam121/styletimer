...
table{
  ...
  <body class="" style="font-family: 'arial', sans-serif">
    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;margin-top:5px; ">Hi <?php echo $employee_name;?>,</p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            <?php echo $fname . ' ' . $lname;?> hat eine Buchung in deinem Salon storniert. <br/>
          </p>
          ...
          <?php if(isset($booking_id)){ ?>
            <p style="font-size: 16px;margin-top:0px;margin-bottom:0px;"><?php echo $this->lang->line('Booking_Id'); ?> : <a style="color:#00b3bf;" href="<?php echo base_url('home/booking_redirect/').url_encode($booking_id); ?>">
              <?php if(!empty($book_id)) { echo $book_id; }
                ...
                ?></a></p> 
            <?php } ?>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;">Service : <?php echo $service_name; ?></p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><?php echo $this->lang->line('Service_Date'); ?> : <?php echo $booking_date; ?></p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;"><?php echo $this->lang->line('Service_Timer'); ?> : <?php echo $booking_time; ?> Uhr</p>
          <p style="font-size: 16px;font-weight:500;margin-top:0px;margin-bottom:0px;">Dauer  : <?php echo $duration; ?> Min.</p>
        </td>
      </tr>
      <tr>
        <td style="padding:0px 30px;">
