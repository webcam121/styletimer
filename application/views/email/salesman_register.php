    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 20px;color:#333;font-weight:500;line-height: 30px; ">Hello <?php echo $data['first_name']; ?>, admin has created your account <br> successfully as a salesman</p>
        </td>
      </tr>      
      <tr>
        <td style="padding:20px 30px 20px;border-top:1px solid #e8e8e8;">
          <table style="">
            <tr>
              ...
              <td>
                <p style="margin-top:0px;margin-bottom:0px;"><span>URL : </span> <?php echo $data['url']; ?></p>
                <p style="margin-top:0px;margin-bottom:0px;"><span>CODE : </span> <?php echo $data['code']; ?></p>
