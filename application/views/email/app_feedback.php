    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p  style="font-size: 20px;color:#333;font-weight:500;line-height: 30px; ">Hello Admin, <br/>There is a new feedback</p>
        </td>
      </tr>      
      <tr>
          ...
          <table style="">
            <tr>
              ...
              <td>
                ...
                <p style="margin-top:0px;margin-bottom:0px;"><span>Feedback : </span> <?php if(!empty($feedback)) echo $feedback; ?></p>
             </td>
            </tr>
