    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          Your appointment with <?php echo $salon_name; ?> has been reschedule. If you want to again book the new service then please visit our website.</p>
          <p>Service Name : <?php echo $service_name; ?></p>
          <p>Service Date : <?php echo $booking_date; ?></p>
          <p>Service Timer : <?php echo $booking_time; ?></p>
          <p>Service Duration : <?php echo $duration; ?></p>
        </td>
      </tr>
      <?php if(!empty($email_text)){ ?>
      <tr>
        <td style="padding:25px 20px 10px 30px;"><span style="font-size: 16px;font-weight:500;color:#333;">
          <h4><b>Zusätzliche Information von <?php echo $salon_name.':'; ?></b></h4>
          <?php echo $email_text; ?></td>
      </tr>
    <?php } ?>
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:27px; ">Have a nice day!</p>
          <span style="font-size: 16px;font-weight:500;color:#333; ">Regards,</span>
          <p style="font-size: 16px;font-weight:500;color:#333;margin-top:0px;margin-bottom:35px; ">The Style Timer Team</p>
        </td>
      </tr>
      <tr>
