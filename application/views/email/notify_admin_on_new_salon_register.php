...
table{
  ...
  <body class="" style="font-family: 'arial', sans-serif">
    ...
    <?php /* <tr>
      ...
      <tr>
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;margin-top:5px; ">Hi <?php echo 'admin'; ?>,</p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
          There is a new registration on styletimer. If you want to chack info click on below salon name and visit the profile.</p>
          <?php if(isset($salonname)){ ?><p>salon name : <a href="<?php echo $url; ?>"><?php echo $salonname; ?></a></p> <?php } ?>
