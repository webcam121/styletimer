      ...
      <tr>
        <td style="padding:0px 30px;">
          ...
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            Du hast eine neue Buchung von <?php echo $booking_detail[0]->first_name; if(!empty($booking_detail[0]->last_name)) echo " ".$booking_detail[0]->last_name; ?>.<br/>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 0px 30px;">
          ...
          <p style="font-size: 16px;margin-top:0px;margin-bottom:0px;"><span><?php echo $this->lang->line('Date'); ?> : </span> <?php echo date('d.m.Y', strtotime($date)); ?></p>
