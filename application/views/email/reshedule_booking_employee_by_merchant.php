      ...
      <tr style="border-bottom:1px solid #e8e8e8;">
        <td style="padding:0px 30px;">
          <p style="font-size: 16px;font-weight:500;margin-top:5px; ">
            Hi <?php echo $main[0]->employee_name; ?>,
          </p>
          <p style="font-size: 16px;font-weight:500;line-height: 20px; ">
            <?php echo $main[0]->business_name; ?> hat eine Buchung von dir verschoben.<br/>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 0px 30px;">
          ...
          <p style="font-size: 16px;margin-top:0px;margin-bottom:0px;"><span>Altes Datum : </span> <?php echo date('d.m.Y', strtotime($odate)); ?></p>
          <p style="font-size: 16px;margin-top:0px;margin-bottom:0px;"><span>Alte Uhrzeit : </span> <?php echo $otime; ?> Uhr</p>
